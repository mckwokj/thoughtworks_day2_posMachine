...
public class ItemDataLoader {
    public static List<ItemInfo> loadAllItemInfos() {
        ItemInfo item1Info = new ItemInfo("Coca-Cola", "ITEM000000", 3);
        ItemInfo item2Info = new ItemInfo("Sprite", "ITEM000001", 3);
        ItemInfo item3Info = new ItemInfo("Battery", "ITEM000004", 2);
